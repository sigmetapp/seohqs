...
**Причина 1:** Пользователь отменил авторизацию или не предоставил разрешения  
**Решение:** Попробуйте авторизоваться снова и убедитесь, что предоставили все необходимые разрешения

**Причина 2:** Приложение находится в режиме Testing в Google Cloud Console, и пользователь не добавлен в список тестовых пользователей  
**Решение:** 
1. Перейдите в Google Cloud Console → APIs & Services → OAuth consent screen
2. Добавьте email пользователя в раздел "Test users" (нажмите "+ ADD USERS")
3. Или переведите приложение в режим Production (нажмите "PUBLISH APP")

**Подробная инструкция:** См. [GOOGLE_OAUTH_TESTING_MODE_FIX.md](./GOOGLE_OAUTH_TESTING_MODE_FIX.md)
