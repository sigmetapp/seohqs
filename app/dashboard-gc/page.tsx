  ...
  if (!isVisible) {
    return (
      <div ref={cardRef} className="relative" style={{ minHeight: '300px' }}>
        <div className="h-64 flex items-center justify-center text-gray-600 dark:text-gray-500 text-sm">
          <div className="text-center">
            <div className="w-4 h-4 border-2 border-gray-400 dark:border-gray-600 border-t-transparent rounded-full animate-spin mx-auto mb-2"></div>
            <div className="text-xs text-gray-600 dark:text-gray-500">Загрузка...</div>
          </div>
        </div>
      </div>
    );
...
const SiteCard = memo(({ 
  ...
  return (
    <div
      className="relative bg-white dark:bg-transparent rounded-lg border border-gray-200 dark:border-transparent shadow-sm dark:shadow-none"
    ...
    >
      ...
      {isLoading ? (
        ...
        <div className="relative w-full">
          <div className="h-64 relative w-full">
            ...
            <div className="absolute top-3 left-3 flex flex-col gap-2">
              {showImpressions && (
                <div className="flex items-center gap-1.5 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm px-2 py-1 rounded border border-gray-200 dark:border-gray-700">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-500 text-center py-1 px-2 h-6">
            {hoveredDate && (
              <span>
        ...
        <div className="h-64 flex items-center justify-center text-gray-600 dark:text-gray-500 text-sm">
          <div className="text-center">
            <div className="text-gray-500 dark:text-gray-400 mb-1">Нет данных</div>
            <div className="text-xs text-gray-600 dark:text-gray-500">за выбранный период</div>
          </div>
        </div>
      )}
    </div>
    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 border border-red-500">
