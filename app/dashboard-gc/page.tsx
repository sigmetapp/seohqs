  ...
  if (!isVisible) {
    return (
      <div ref={cardRef} className="relative" style={{ minHeight: '300px' }}>
        <div className="h-64 flex items-center justify-center text-gray-500 dark:text-gray-500 text-gray-500 text-sm">
          <div className="text-center">
            <div className="w-4 h-4 border-2 border-gray-600 dark:border-gray-600 border-gray-400 border-t-transparent rounded-full animate-spin mx-auto mb-2"></div>
            <div className="text-xs text-gray-500 dark:text-gray-500 text-gray-500">Загрузка...</div>
          </div>
        </div>
      </div>
    );
...
const SiteCard = memo(({ 
  ...
  return (
    <div
      className="relative bg-gray-800 dark:bg-gray-800 bg-white rounded-lg p-4 border border-gray-700 dark:border-gray-700 border-gray-200 shadow-sm"
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <p className={`text-sm truncate transition-all duration-200 ${
              blurMode && !isHovered ? 'blur-sm select-none' : 'text-gray-400 dark:text-gray-400 text-gray-600'
            }`}>
              {siteData.domain}
            </p>
            {siteData.status && (
          ...
          <Link
            ...
            className="text-blue-400 dark:text-blue-400 text-blue-600 hover:text-blue-300 dark:hover:text-blue-300 hover:text-blue-700 hover:underline text-sm whitespace-nowrap ml-2 flex-shrink-0"
          >
            Открыть →
          </Link>
        </div>
      ...
      {/* График */}
      {isLoading ? (
        <div className="h-64 flex items-center justify-center text-gray-400 dark:text-gray-400 text-gray-600 text-sm">
        ...
        <div className="relative w-full">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-500 text-gray-500 text-center py-1 px-2 h-6">
            {hoveredDate && (
              <span>
        ...
        <div className="h-64 flex items-center justify-center text-gray-500 dark:text-gray-500 text-gray-500 text-sm">
          <div className="text-center">
            <div className="text-gray-400 dark:text-gray-400 text-gray-600 mb-1">Нет данных</div>
            <div className="text-xs text-gray-500 dark:text-gray-500 text-gray-500">за выбранный период</div>
          </div>
        </div>
      )}
    </div>
...
export default function DashboardGCPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 dark:bg-gray-900 bg-gray-50 text-white dark:text-white text-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold mb-2 text-white dark:text-white text-gray-900">Dashboard GC</h1>
            <p className="text-gray-400 dark:text-gray-400 text-gray-600">Все сайты с Google Console</p>
          </div>
          <Link
            href="/sites"
            className="px-4 py-2 bg-gray-700 dark:bg-gray-700 bg-gray-200 hover:bg-gray-600 dark:hover:bg-gray-600 hover:bg-gray-300 rounded text-sm text-white dark:text-white text-gray-900"
          >
            ← Назад к сайтам
          </Link>
        </div>
        ...
        {loading ? (
          <div className="bg-gray-800 dark:bg-gray-800 bg-white rounded-lg p-8 text-center border border-gray-700 dark:border-gray-700 border-gray-200">
            <div className="text-gray-400 dark:text-gray-400 text-gray-600">Загрузка данных...</div>
          </div>
        ) : error ? (
          <div className="bg-gray-800 dark:bg-gray-800 bg-white rounded-lg p-8 border border-red-500">
            <div className="text-red-400 dark:text-red-400 text-red-600">
          ...
          <>
            ...
            <div className="sticky top-0 z-50 bg-gray-800 dark:bg-gray-800 bg-white rounded-lg p-2 mb-6 border border-gray-700 dark:border-gray-700 border-gray-200 shadow-lg backdrop-blur-sm">
              <div className="flex flex-nowrap gap-2 items-center overflow-x-auto">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  <select
                    ...
                    className="px-2 py-1 rounded text-sm bg-gray-700 dark:bg-gray-700 bg-gray-100 text-gray-300 dark:text-gray-300 text-gray-700 border border-gray-600 dark:border-gray-600 border-gray-300 hover:bg-gray-600 dark:hover:bg-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 cursor-pointer appearance-none pr-7"
                    style={{
                  ...
                  {selectedTagIds.length > 0 && tags.find(t => t.id === selectedTagIds[0]) && (
                    <div 
                      className="w-3.5 h-3.5 rounded border border-gray-600 dark:border-gray-600 border-gray-300 flex-shrink-0"
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  <label className="flex items-center gap-1 text-sm cursor-pointer whitespace-nowrap">
                    <input
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-gray-300 dark:text-gray-300 text-gray-700 text-xs">Показы</span>
                  </label>
                  <label className="flex items-center gap-1 text-sm cursor-pointer whitespace-nowrap">
                    <input
                      type="checkbox"
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-gray-300 dark:text-gray-300 text-gray-700 text-xs">Клики</span>
                  </label>
                  <label className="flex items-center gap-1 text-sm cursor-pointer whitespace-nowrap">
                    <input
                      type="checkbox"
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-gray-300 dark:text-gray-300 text-gray-700 text-xs">Позиции</span>
                  </label>
                </div>
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  <input
                    ...
                    className="px-2 py-1 rounded text-sm bg-gray-700 dark:bg-gray-700 bg-gray-100 text-gray-300 dark:text-gray-300 text-gray-700 border border-gray-600 dark:border-gray-600 border-gray-300 hover:bg-gray-600 dark:hover:bg-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-24"
                  />
                </div>
              </div>
            </div>
            ...
            {visibleSites.length === 0 ? (
              <div className="bg-gray-800 dark:bg-gray-800 bg-white rounded-lg p-8 text-center border border-gray-700 dark:border-gray-700 border-gray-200">
                <p className="text-gray-400 dark:text-gray-400 text-gray-600 mb-4">Сайты не найдены</p>
                <p className="text-gray-500 dark:text-gray-500 text-gray-500 text-sm mb-4">
