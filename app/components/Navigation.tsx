            ...
            {loading ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 px-3 py-2 rounded text-sm font-bold transition-colors flex items-center justify-center w-10 h-10 shadow-sm hover:shadow-md"
